print(">>> Trabalhando com conjuntos, os sets <<<\n")
...
print("set(assistiram): ", set(assistiram))  # conjunto: representação de um conjunto de elementos não repitidos. se usa {} e retorna ums ordem aleatória (a ordem não importa)
...
print("usuario_data_science | usuario_machine_learning: ", usuarios_data_science | usuarios_machine_learning)  # (OU)

print("\n\n >>> Mais operações de conjuntos <<< \n")

print("usuario_data_science & usuario_machine_learning: ", usuarios_data_science & usuarios_machine_learning)  # (E)

print("usuario_data_science - usuario_machine_learning: ", usuarios_data_science - usuarios_machine_learning)

print("usuarios_data_science ^ usuarios_machine_learning: ", usuarios_data_science ^ usuarios_machine_learning)  # Ou exclusivo: Aparece só em um dos dois conjuntos

print("\n\n >>> Outro tipo de conjunto e conjuntos de outros tipos <<<\n")

usuarios = {1, 5, 76, 34, 52, 13, 17}
print("usuarios: ", usuarios)
print("tamanho usuarios: ", len(usuarios))

usuarios.add(765)  # para adicionar um elemento no conjunto

print("usuarios.add(765): ", usuarios)

usuarios = frozenset(usuarios)  # para conjelar os usuários -> não se pode adicioar elementos
print("fronzenset(usuarios): ", usuarios)

meu_texto = "Bem vindo meu nome é Guilherme eu gosto muito de nomes e tenho o meu cachorro e gosto muito de cachorro"
print("meu_texto.split() :", meu_texto.split()) # para quebrar o meu texo -> se usa a vírgula como parâmetro
print("set(meu_texto.split()): ", set(meu_texto.split())) # para tirar as repeticões

print("\n\n >>> Dicionários <<<\n")

print("Dicioário (Mapa, etc)")
...
print("aparicoes['cachorro']: ", aparicoes["cachorro"])

print("\n\n >>> Mais operações de dicionários <<< \n")

aparicoes["Calos"] = 1

print("aparicoes['Calos'] = 1")
print("aparicoes: ", aparicoes)

del aparicoes["Calos"]
print("del aparicoes['Calos']")

print("aparicoes: ", aparicoes)

print("for elemento in aparicoes:")
for elemento in aparicoes:
    print("elemento: ", elemento)

print("for elemento in aparicoes.keys():")
for elemento in aparicoes.keys():
    print("elemento: ", elemento)

print("for elemento in aparicoes.values():")
for elemento in aparicoes.values():
    print("elemento: ", elemento)

print("for elemento in aparicoes.itens():")
for elemento in aparicoes.items():
    print("elemento: ", elemento)

print("for chave, valor in aparicoes.itens():")
...
meu_texto = "Bem vindo meu nome é Guilherme eu gosto muito de nomes e tenho o meu cachorro e gosto muito de cachorro"
print("meu_texto: ", meu_texto)
meu_texto = meu_texto.lower()
print("meu_texto.lower(): ", meu_texto)

aparicoes = {}

print("for paravra in meu_texto.split():")
for paravra in meu_texto.split():
    ate_agora = aparicoes.get(paravra, 0)  # get -> procura a palavra, se estiver la devolve o valor e se não estiver devolve zero
    aparicoes[paravra] = ate_agora + 1
print(aparicoes)
...
print("Testando o uso de diversas colecções\n")
...
def analisa_frequencia_de_letras(texto):
    ...
    for caractere, proporcao in mais_comuns:
        print(" {}, =>, proporcao {:.2f}%".format(caractere, proporcao * 100))
