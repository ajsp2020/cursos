...
class Serie(Programa):
    ...
    def __str__(self):  # para converter um objeto para uma string
...
class Playlist:
    ...
    def __getitem__(self, item):  # para obter todas as vantágens de um iterável
    ...
    def __len__(self):  # para se encontrar o tamanho do playlist
