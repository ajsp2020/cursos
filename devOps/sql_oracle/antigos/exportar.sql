--------------------------------------------------------
--  Arquivo criado - Terça-feira-Junho-22-2021   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007716" ON "SYSTEM"."ITEMS_NOTAS" ("NUMERO", "CODIGO") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007707" ON "SYSTEM"."NOTAS" ("NUMERO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007401" ON "SYSTEM"."PRODUTOS" ("CODIGO") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C007403" ON "SYSTEM"."VENDEDORES" ("MATRICULA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."NOTAS" MODIFY ("IMPOSTO" NOT NULL ENABLE);
